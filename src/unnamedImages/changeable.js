...
contract Changeable is ERC721URIStorage, Ownable{
  ...
  function changeVariation(uint _tokenID, uint _variationID) public {
      require(spotContract.balanceOf(_msgSender()) > 0, "Analog: You don't own a spot!");
      require(validVariations[_tokenID][_variationID], "Invalid Variation!");
 
 
   //         if (_variation == 2) {
   //     Require(spotContract.balanceOf(msgSender()) > 9, "not enough spots ");
